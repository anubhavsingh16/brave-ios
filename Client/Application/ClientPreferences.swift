...
extension Preferences {
    ...
    final class DefaultBrowserIntro {
        /// Should be true if the app was installed after default browser intro screen was introduced.
        /// It's nil by default, should be set up at first app launch after this preference is introduced.
        static let isNewUser =
            Option<Bool?>(key: "general.default-browser-intro-new-user", default: nil)
